...
#define Version ReadIni(SourcePath + "\\autogenerated_version.ini","version","version","0")
...
Source: "autogenerated_version.ini"; DestDir: "{app}"
Source: "anamorphy.ico"; DestDir: "{app}"
Source: "*.png"; DestDir: "{app}"
Source: "sample_pics\*.png"; DestDir: "{app}\sample_pics"
Source: "README.html"; DestDir: "{app}"; Flags: isreadme

[Icons]
Name: "{group}\Anamorphy"; Filename: "{app}\Anamorphy.exe"; IconFilename: "{app}\anamorpy.ico"
