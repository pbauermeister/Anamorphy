#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.4 on Wed Oct  2 20:20:04 2013
...
class AutogeneratedMainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Menu Bar end
        self.window_perspective = wx.Window(self, -1)
        self.label_hint = wx.StaticText(self, -1, _("hint"))
        self.sizer_11_staticbox = wx.StaticBox(self, -1, _("Perspective"))
        self.button_presets_wizard = wx.Button(self, -1, _("Wizard..."))
        self.label_11 = wx.StaticText(self, -1, _("Length"))
        self.choice_units_length = wx.Choice(self, -1, choices=[_("mm"), _("inch")])
        self.sizer_111_staticbox = wx.StaticBox(self, -1, _("Units"))
        self.label_6_copy_1 = wx.StaticText(self, -1, _("Format"))
        self.choice_card_format = wx.Choice(self, -1, choices=[_("Set to:"), _("A3"), _("A3 landscape"), _("A4"), _("A4 landscape"), _("Letter"), _("Letter landscape")])
        self.label_9_copy_1 = wx.StaticText(self, -1, _("Fold"), style=wx.ALIGN_RIGHT)
        self.choice_card_fold = wx.Choice(self, -1, choices=[_("Horizontal valley"), _("Horizontal mountain"), _("Vertical valley"), _("Vertical mountain"), _("None")])
        self.label_7_copy_1 = wx.StaticText(self, -1, _("Width"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_card_width = wx.SpinCtrl(self, -1, "", min=100, max=1000, style=wx.SP_ARROW_KEYS | wx.SP_WRAP | wx.TE_RICH | wx.TE_RICH2 | wx.TE_AUTO_URL | wx.TE_NOHIDESEL | wx.TE_LINEWRAP)
        self.label_8_copy_1 = wx.StaticText(self, -1, _("Height"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_card_height = wx.SpinCtrl(self, -1, "", min=100, max=1000)
        self.label_10_copy_1 = wx.StaticText(self, -1, _("Angle"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_card_angle = wx.SpinCtrl(self, -1, "", min=0, max=180)
        self.label_4_copy_1 = wx.StaticText(self, -1, _("Elevation"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_card_elevation = wx.SpinCtrl(self, -1, "", min=-1000, max=1000)
        self.label_12 = wx.StaticText(self, -1, _("Background"))
        self.checkbox_card_background = wx.CheckBox(self, -1, "")
        self.text_ctrl_card_image = wx.TextCtrl(self, -1, "")
        self.button_card_filename = wx.Button(self, -1, _("..."))
        self.sizer_113_staticbox = wx.StaticBox(self, -1, _("Card"))
        self.label_2_copy = wx.StaticText(self, -1, _("Azimuth"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_camera_azimuth = wx.SpinCtrl(self, -1, "", min=0, max=180)
        self.label_3_copy = wx.StaticText(self, -1, _("Altitude"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_camera_altitude = wx.SpinCtrl(self, -1, "", min=0, max=90)
        self.label_4_copy = wx.StaticText(self, -1, _("Distance"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_camera_distance = wx.SpinCtrl(self, -1, "", min=200, max=10000)
        self.label_5_copy = wx.StaticText(self, -1, _("FOV"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_camera_fov = wx.SpinCtrl(self, -1, "", min=30, max=180)
        self.label_camera_pos = wx.StaticText(self, -1, _("camera"), style=wx.ALIGN_RIGHT)
        self.sizer_112_staticbox = wx.StaticBox(self, -1, _("Camera"))
        self.text_ctrl_marquee_image = wx.TextCtrl(self, -1, "")
        self.button_marquee_filename = wx.Button(self, -1, _("..."))
        self.label_1_copy = wx.StaticText(self, -1, _("Show"))
        self.checkbox_marquee_show = wx.CheckBox(self, -1, "")
        self.label_6_copy = wx.StaticText(self, -1, _("Width"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_marquee_width = wx.SpinCtrl(self, -1, "", min=0, max=359)
        self.label_8 = wx.StaticText(self, -1, _("Distance"), style=wx.ALIGN_RIGHT)
        self.spin_ctrl_marquee_distance = wx.SpinCtrl(self, -1, "", min=200, max=10000)
        self.label_9 = wx.StaticText(self, -1, _("Hor. offset"))
        self.spin_ctrl_marquee_hoff = wx.SpinCtrl(self, -1, "", min=-1000, max=1000)
        self.label_10 = wx.StaticText(self, -1, _("Ver. offset"))
        self.spin_ctrl_marquee_voff = wx.SpinCtrl(self, -1, "", min=-1000, max=1000)
        self.label_2_copy_1 = wx.StaticText(self, -1, _("Tiles"))
        self.spin_ctrl_marquee_tiles_m = wx.SpinCtrl(self, -1, "", min=1, max=10)
        self.label_3_copy_1 = wx.StaticText(self, -1, _("x"))
        self.spin_ctrl_marquee_tiles_n = wx.SpinCtrl(self, -1, "", min=1, max=10)
        self.sizer_114_staticbox = wx.StaticBox(self, -1, _("Marquee"))
        self.window_anamorphosis = wx.Window(self, -1)
        self.sizer_11_copy_staticbox = wx.StaticBox(self, -1, _("Anamorphosis Preview"))
        self.button_export_pdf = wx.Button(self, -1, _("Export PDF..."))
        self.sizer_2_copy_staticbox = wx.StaticBox(self, -1, _("Document"))
        self.label_7 = wx.StaticText(self, -1, _("Width"))
        self.spin_ctrl_export_bitmap_width = wx.SpinCtrl(self, -1, "", min=10, max=100000)
        self.label_13 = wx.StaticText(self, -1, _("Height"))
        self.spin_ctrl_export_bitmap_height = wx.SpinCtrl(self, -1, "", min=10, max=100000)
        self.button_export_image = wx.Button(self, -1, _("Export PNG..."))
        self.sizer_2_staticbox = wx.StaticBox(self, -1, _("Image"))
        self.button_export_fullscreen = wx.Button(self, -1, _("Show"))
        self.sizer_2_copy_1_staticbox = wx.StaticBox(self, -1, _("Fullscreen"))
    ...
    def __set_properties(self):
        ...
        self.choice_units_length.SetMinSize((70, 29))
        self.choice_units_length.SetSelection(0)
        self.choice_card_format.SetMinSize((70, 29))
        self.choice_card_format.SetSelection(0)
        self.choice_card_fold.SetMinSize((70, 29))
        ...
        self.spin_ctrl_card_elevation.SetMinSize((70, 25))
        self.button_card_filename.SetMinSize((28, 28))
        self.label_2_copy.SetMinSize((55, 15))
    ...
    def __do_layout(self):
        ...
        grid_sizer_1 = wx.FlexGridSizer(1, 2, 0, 10)
        grid_sizer_12 = wx.FlexGridSizer(3, 1, 0, 5)
        ...
        grid_sizer_1141 = wx.FlexGridSizer(5, 2, 0, 10)
        ...
        grid_sizer_1121 = wx.FlexGridSizer(4, 2, 0, 10)
        ...
        grid_sizer_1131 = wx.FlexGridSizer(5, 2, 0, 10)
        ...
        grid_sizer_6.Add(self.button_presets_wizard, 0, wx.EXPAND | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1111.Add(self.label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1111.Add(self.choice_units_length, 0, 0, 0)
        sizer_111.Add(grid_sizer_1111, 1, wx.EXPAND, 0)
        grid_sizer_6.Add(sizer_111, 1, wx.EXPAND, 0)
        grid_sizer_7.Add(self.label_6_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 5)
        grid_sizer_7.Add(self.choice_card_format, 0, 0, 0)
        grid_sizer_7.Add(self.label_9_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.choice_card_fold, 0, 0, 0)
        grid_sizer_7.AddGrowableCol(0)
        grid_sizer_8.Add(grid_sizer_7, 1, wx.EXPAND, 0)
        grid_sizer_1131.Add(self.label_7_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1131.Add(self.spin_ctrl_card_width, 0, wx.ALIGN_RIGHT, 0)
        grid_sizer_1131.Add(self.label_8_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1131.Add(self.spin_ctrl_card_height, 0, wx.ALIGN_RIGHT, 0)
        grid_sizer_1131.Add(self.label_10_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1131.Add(self.spin_ctrl_card_angle, 0, wx.ALIGN_RIGHT, 0)
        grid_sizer_1131.Add(self.label_4_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1131.Add(self.spin_ctrl_card_elevation, 0, 0, 0)
        grid_sizer_1131.Add(self.label_12, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1131.Add(self.checkbox_card_background, 0, wx.ALIGN_RIGHT, 0)
        grid_sizer_1131.AddGrowableCol(0)
        grid_sizer_8.Add(grid_sizer_1131, 1, wx.EXPAND, 0)
        grid_sizer_2_copy_1.Add(self.text_ctrl_card_image, 0, wx.EXPAND, 0)
        ...
        grid_sizer_6.Add(sizer_113, 1, wx.EXPAND, 0)
        grid_sizer_6.AddGrowableCol(0)
        sizer_1.Add(grid_sizer_6, 1, wx.LEFT | wx.EXPAND, 5)
        grid_sizer_1121.Add(self.label_2_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1121.Add(self.spin_ctrl_camera_azimuth, 0, 0, 0)
        grid_sizer_1121.Add(self.label_3_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1121.Add(self.spin_ctrl_camera_altitude, 0, 0, 0)
        grid_sizer_1121.Add(self.label_4_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1121.Add(self.spin_ctrl_camera_distance, 0, 0, 0)
        grid_sizer_1121.Add(self.label_5_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_112.Add(self.label_camera_pos, 0, wx.TOP | wx.EXPAND | wx.ALIGN_RIGHT, 5)
        grid_sizer_5.Add(sizer_112, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.text_ctrl_marquee_image, 0, wx.EXPAND, 0)
        grid_sizer_2.Add(self.button_marquee_filename, 0, 0, 0)
        grid_sizer_2.AddGrowableCol(0)
        grid_sizer_3.Add(grid_sizer_2, 1, wx.EXPAND, 0)
        grid_sizer_1141.Add(self.label_1_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1141.Add(self.checkbox_marquee_show, 0, 0, 0)
        grid_sizer_1141.Add(self.label_6_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1141.Add(self.spin_ctrl_marquee_width, 0, 0, 0)
        grid_sizer_1141.Add(self.label_8, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1141.Add(self.spin_ctrl_marquee_distance, 0, 0, 0)
        grid_sizer_1141.Add(self.label_9, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1141.Add(self.spin_ctrl_marquee_hoff, 0, 0, 0)
        grid_sizer_1141.Add(self.label_10, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_9.Add(self.label_2_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_5.Add(sizer_114, 1, wx.EXPAND, 0)
        ...
        grid_sizer_12.Add(sizer_11_copy, 1, wx.EXPAND, 0)
        ...
        grid_sizer_10.Add(self.label_7, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_10.Add(self.spin_ctrl_export_bitmap_width, 0, 0, 0)
        grid_sizer_10.Add(self.label_13, 0, wx.ALIGN_CENTER_VERTICAL, 0)
...
class AutogeneratedWizardDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.radio_box_affect = wx.RadioBox(self, -1, _("Affect"), choices=[_("Camera, and placements   "), _("and card size   "), _("and marquee image")], majorDimension=1, style=wx.RA_SPECIFY_ROWS)
        self.wizard_button_1 = wx.BitmapButton(self, -1, wx.Bitmap("wizard-card-flat.png", wx.BITMAP_TYPE_ANY))
        self.label_1 = wx.StaticText(self, -1, _("Simple card\n\nLaying flat"))
        self.wizard_button_4 = wx.BitmapButton(self, -1, wx.Bitmap("wizard-box-h.png", wx.BITMAP_TYPE_ANY))
        self.label_4 = wx.StaticText(self, -1, _("Horizontal box\n\nSeen from slightly above"))
        self.wizard_button_2 = wx.BitmapButton(self, -1, wx.Bitmap("wizard-card-h.png", wx.BITMAP_TYPE_ANY))
        self.label_2 = wx.StaticText(self, -1, _("Folded card\n\nLaying on the back half"))
        self.wizard_button_5 = wx.BitmapButton(self, -1, wx.Bitmap("wizard-box-v.png", wx.BITMAP_TYPE_ANY))
        self.label_5 = wx.StaticText(self, -1, _("Vertical box\n\nSeen from the sides"))
        self.wizard_button_3 = wx.BitmapButton(self, -1, wx.Bitmap("wizard-card-v.png", wx.BITMAP_TYPE_ANY))
        self.label_3 = wx.StaticText(self, -1, _("Folded card\n\nStanding on the edge"))
        self.wizard_button_6 = wx.BitmapButton(self, -1, wx.Bitmap("wizard-building.png", wx.BITMAP_TYPE_ANY))
        self.label_6 = wx.StaticText(self, -1, _("Building\n\nSeen from the floor\n(elevation must be half the height)"))
